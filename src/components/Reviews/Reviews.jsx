            ...
            <section data-aos="zoom-in" data-aos-duration="750"
                ...
                <div className="group relative flex-1 mt-20 px-0 md:px-8 lg:px-0 lg:mt-0">
                    <div data-aos="zoom-in" className="relative mb-16 md:left-16 z-5 hover:z-20">
                        <div className={`opacity-20 hover:opacity-100 p-10 rounded-lg w-11/12 md:w-9/12 mx-auto duration-150 border ${isDarkMode === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                            <img className={`absolute -top-6 left-8 border-4 rounded-full bg-white ${isDarkMode === 'dark' ? 'border-gray-800' : 'border-white'}`}
                    ...
                    <div data-aos="zoom-in" className="absolute top-32 group-hover:z-5 z-10 ">
                        <div className={`hover:!opacity-100 p-10 group-hover:opacity-20 rounded-lg w-11/12 md:w-9/12 mx-auto duration-150 border ${isDarkMode === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                            <img className={`absolute -top-6 left-8 border-4 rounded-full bg-white ${isDarkMode === 'dark' ? 'border-gray-800' : 'border-white'}`}
                                src="https://i.ibb.co/pJmH4Nv/client.png" alt="" />
