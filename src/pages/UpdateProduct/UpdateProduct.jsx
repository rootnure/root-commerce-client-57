...
const UpdateProduct = () => {
    ...
    return (
        <section>
            ...
            <div className="my-6">
                <h3><Link className="text-xl font-pacifico flex items-center gap-2 p-4 hover:bg-orange-600 w-fit rounded-lg hover:text-white duration-150" to={`/${oldBrand}`}><BsArrowLeft></BsArrowLeft>Back to {oldBrand}</Link></h3>
            </div>
            <div>
